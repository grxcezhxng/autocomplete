...
public class Term implements Comparable<Term> {
    ...
    public static void main(String[] args)   {
        //test all methods
        Term word1 = new Term("read", 3); 
        Term word2 = new Term("reeds", 4); 
        System.out.println(word1.toString()); 
        System.out.println(word2.toString()); 
        System.out.println(word1.byReverseWeightOrder().compare(word1, word2)); 
        System.out.println(word1.byPrefixOrder(1).compare(word1, word2));
        System.out.println(word1.byPrefixOrder(4).compare(word1, word2));
